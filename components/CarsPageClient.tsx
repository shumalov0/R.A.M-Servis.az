...
export default function CarsPageClient({ cars, translations, defaultPriceRange }: CarsPageClientProps) {
  ...
  }, [filters, priceRange, year, carClass, debouncedSearch, sort, cars]);
